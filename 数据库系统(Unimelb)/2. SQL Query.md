...
> > >      ```
> > >
> > >      | $\text{AVG(Balance)}$ | $\text{\\}$ | $\text{MAX(Balance)}$ | $\text{\\}$ | $\text{SUM(Balance)}$ |
> > >      | :-------------------: | :---------: | :-------------------: | :---------: | :-------------------: |
...
> > >
> > >    | $\small\text{AID}$ | $\small\text{Name}$  | $\small\text{Descript}$  | $\small\text{\\}$ | $\small\text{SID}$ | $\small\text{Name}$ | $\small\text{Phone}$ | $\small\text{\\}$ | $\small\text{BID}$ |  $\small\text{Name}$  | $\small\text{Phone}$ |
> > >    | :----------------: | :------------------: | :----------------------: | :---------------: | :----------------: | :-----------------: | :------------------: | :---------------: | :----------------: | :-------------------: | :------------------: |
