...
> >
> > ### $\text{2.1.1. DDL Commands: Set up DB}$​  
> >
...
> >
> >
> > ### $\text{2.1.3. Other: Database Administration}$ 
> >
> > > :one:意外删除的恢复: `BACKUP TABLE/RESTORE TABLE`(二者其实并非标准$\text{SQL}$​命令)
> > >
> > > :two:展示表格模式($\text{Scheme}$): `DESCRIBE <表名>` 
> > >
> > > ```sql
> > > CREATE TABLE Customer (
...
> > >
> > > :three:`USE <db_name>`: 挑选进入哪个数据库来操作
>
> ## $\text{2.2. SQL}$ 语法特点
>
