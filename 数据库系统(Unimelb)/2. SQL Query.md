...
> > > 2. 示例
> > >
> > >    | $\text{CustomerID}$ | $\text{AccountID}$ | $\text{Balance}$ |
> > >    | :-----------------: | :----------------: | :--------------: |
> > >    |     $\text{1}$      |     $\text{1}$     |   $\text{200}$   |
> > >    |     $\text{1}$      |     $\text{2}$     |   $\text{100}$   |
> > >    |     $\text{2}$      |     $\text{1}$     |   $\text{400}$   |
...
> > >      ```
> > >    
> > >      | $\text{COUNT(CustomerID)}$ |  \   | $\text{COUNT(DISTINCT CustomerID)}$ |
> > >      | :------------------------: | :--: | :---------------------------------: |
> > >      |         $\text{4}$         |  \   |             $\text{3}$              |
> > >    
> > >    - `AVG/MAX/MAX`示例   
...
> > >      ```
> > >    
> > >      | $\text{AVG(Balance)}$ |  \   | $\text{MAX(Balance)}$ |  \   | $\text{SUM(Balance)}$ |
> > >      | :-------------------: | :--: | :-------------------: | :--: | :-------------------: |
> > >      |     $\text{250}$      |  \   |     $\text{200}$      |  \   |     $\text{300}$      |
> > >      |           \           |  \   |           \           |  \   |     $\text{400}$      |
> > >      |           \           |  \   |           \           |  \   |     $\text{300}$      |
> > >
> > > 3. `SUM()`补充：
...
> > > >    ```
> > > >
> > > >    | $\text{CustID}$ | $\text{Account}$ | $\text{Balance}$ | $\xrightarrow[查询]{结果}$ | $\text{CustID}$ | $\text{AveBalance}$ |
> > > >    | :-------------: | :--------------: | :--------------: | :------------------------: | :-------------: | :-----------------: |
...
> > > >    ```
> > > >
> > > >    | $\small\text{Subject}$ | $\small\text{Semester}$ | $\small\text{Attendee}$ | $\xrightarrow[查询]{结果}$ | $\small\text{Subject}$ | $\small\text{Semester}$ | $\small\text{COUNT(*)}$ |
> > > >    | :--------------------: | :---------------------: | :---------------------: | :------------------------: | :--------------------: | :---------------------: | :---------------------: |
> > > >    | $\small\text{ITB001}$  |       $\text{1}$        |   $\small\text{John}$   |             \              | $\small\text{ITB001}$  |       $\text{1}$        |       $\text{3}$        |
> > > >    | $\small\text{ITB001}$  |       $\text{1}$        |   $\small\text{Bob}$    |             \              | $\small\text{ITB001}$  |       $\text{2}$        |       $\text{2}$        |
> > > >    | $\small\text{ITB001}$  |       $\text{1}$        |  $\small\text{Mickey}$  |             \              | $\small\text{IMK114}$  |       $\text{1}$        |       $\text{2}$        |
> > > >    | $\small\text{ITB001}$  |       $\text{2}$        |  $\small\text{Jenny}$   |             \              |           \            |            \            |            \            |
> > > >    | $\small\text{ITB001}$  |       $\text{2}$        |  $\small\text{James}$   |             \              |           \            |            \            |            \            |
> > > >    | $\small\text{IMK114}$  |       $\text{1}$        |   $\small\text{John}$   |             \              |           \            |            \            |            \            |
> > > >    | $\small\text{IMK114}$  |       $\text{1}$        |  $\small\text{Erica}$   |             \              |           \            |            \            |            \            |
> > > >
...
> > > >    - 作为​聚合函数的补充
> > > >
> > > >      |      `HAVING` $\text{Clause}$      |   `WHERE` $\text{Clause}$    |
> > > >      | :--------------------------------: | :--------------------------: |
...
> > > >
> > > >    | $\text{CustID}$ | $\text{Account}$ | $\text{Balance}$ |
> > > >    | :-------------: | :--------------: | :--------------: |
...
> > > >    ```
>
> ## $\text{3.3. }$查询表中内容: $\text{Sub/Nesting Query}$​​ 
>
